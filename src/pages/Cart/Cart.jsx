...
const Cart = () => {
  ...
  if (loading) return <p className="text-center mt-10 text-lg">Loading your cart...</p>;
         ...
         return <div
          ...
          >
            ...
            <div className="flex-1 w-full">
              <h3 className="text-xl font-medium">{item.productId.title}</h3>
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                <button
                  onClick={() => dispatch(addToCart({productId: item.productId._id, qty: 1}))}
                  className="px-3 py-1 bg-gray-200 text-xl rounded hover:bg-gray-300"
                >
                  +
                </button>
